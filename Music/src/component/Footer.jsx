          ...
          >
            ...
            {isAlbum && (
              <div
                ...
                className="bg-[#1a1b26] text-white p-4 rounded-lg w-[350px] h-[584px] mx-auto absolute -bottom-3 -translate-y-[15%] right-0 overflow-hidden"
              >
                ...
                <div className="bg-[#f04b4b] p-2 rounded-md flex items-center mb-4">
                  ...
                  <div className="w-[60%]">
                    <h3 className="font-medium truncate">{playSong.song_name}</h3>

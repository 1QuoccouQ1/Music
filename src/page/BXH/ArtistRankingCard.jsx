...
function ArtistRankingCard({ rank, artist, song }) {
    ...
    return (
        <div
            className={`relative border-t-4 ${rankClasses[rank]} rounded-lg p-4 bg-gray-800 w-full sm:w-[27.1875rem] ${
        ...
        >
            ...
            <h3 className='text-white mt-1 mb-3 text-center font-bold text-base sm:text-lg'>{artist.name}</h3>
            ...
            <div className='flex items-center bg-gray-700 p-3 sm:p-4 rounded-lg border border-blue-500'>
                ...
                {/* Thời lượng bài hát */}
                <span className='text-gray-400 text-xs sm:text-sm'>{song.duration}</span>
            </div>
        </div>
    );
}

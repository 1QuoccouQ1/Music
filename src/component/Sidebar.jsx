...
import { AudioLines, ChartNoAxesCombined } from "lucide-react";
...
function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`max-w-64 bg-sidebar lg:px-6 px-1 lg:px-5 py-3 fixed top-0 left-0 h-full lg:w-56 z-40 ${
              ...
              <div className="text-sm">
                {menuItems.map((item, index) => {
                  ...
                  return (
                    <Link
                      key={index}
                      className={`flex items-center space-x-2 py-3 px-1 lg:px-3 hover:shadow-lg rounded-lg duration-300 cursor-pointer ${
                        isActive

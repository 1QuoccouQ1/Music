        ...
        <>
            <div className='flex md:justify-between  w-full h-auto flex-shrink py-4   h-[90px] px-10    bg-medium  text-zinc-700 flex items-center justify-center z-10 '>
                <div className='relative '>
                    ...
                    {isFocused &&
                        (songs.length > 0 || singers.length > 0 || loading) && (
                                            ...
                                            >
                                                ...
                                                <div className='flex-grow'>
                                                    ...
                                                    'Basic' ? (
                                                      ...
                                                      'Plus' ? (
                                                        <p className="bg-gradient-to-r from-[#EAB308] to-[#FF0065] hover:opacity-85 text-white text-sm rounded-full px-4 transition-all duration-300 w-fit group">
                                                        SoundWave Plus <br />
                                                      ...
                                                      <p className="bg-gradient-to-r from-[#DB2777] to-[#FF0065] hover:opacity-85 text-white text-sm rounded-full px-4 transition-all duration-300 w-fit group">
                                                    ...
                                                    >
                                                        ...
                                                        <span className='flex-grow text-left text-sm'>
                                                            ...
                                                            item.href.startsWith(
                                                                ...
                                                                >
                                                                    {item.label}
                                                                </Link> // Dùng Link cho đường dẫn nội bộ
                                                            ) : (
                                                                <a
                                                                    href={
                                                                        item.href
                                                                ...
                                                                >
                                                                    {item.label}
                                                                </a> // Dùng thẻ a cho liên kết ngoại vi
                                                            )}
                                                        </span>
                                                        <ChevronRight className='w-5 h-5 text-gray-400' />
                                                    </button>
